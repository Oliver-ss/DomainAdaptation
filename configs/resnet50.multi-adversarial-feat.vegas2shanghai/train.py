...
class Trainer(object):
    def __init__(self, config, args):
        ...
        self.D_low = Discriminator_small(num_classes=256, ndf=64)
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            A_low_feat_detach = A_feat.detach()
            B_low_feat_detach = B_feat.detach()
            # source
